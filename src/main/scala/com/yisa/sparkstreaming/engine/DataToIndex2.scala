...
object DataToIndex2 {
  ...
  def convert_Pass_info_index(triple: PassinfoForHive3, PASS_INFO_INDEX_TABLE: String) = {
  ...
  def convert_Pass_yearid_index(triple: PassinfoForHive3, zk_server_str: String, useRedisOrNot: Boolean, PASS_YEARID_INDEX_TABLE: String) = {
